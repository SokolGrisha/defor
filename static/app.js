...
module.exports = function EthAPI(to_address, abi) {
	...
	this.add = function (props) {
		...
		this.web3.eth.getTransactionCount(props.fromAdress).then(function (current_nonce) {
			var payloadData = _this.contract.methods.add(props.addHash).encodeABI();
			var rawTx = {
...
},{"./store":4,"./views/App.vue":6,"vee-validate":80,"vue":82,"vuex":84}],4:[function(require,module,exports){
'use strict';
...
module.exports = {
  ...
  mutations: {
    ...
    setEthKey: function setEthKey(state, key) {
      state.ethKey = key;
  ...
  actions: {
    ...
    addInfoToServer: function addInfoToServer(_ref2, data) {
      var state = _ref2.state,
          commit = _ref2.commit;

      axios.post(state.rootApi + '/add_info', data).then(function (response) {
        if (data.is_valid) Materialize.toast('Новый маркер создан!', 3000);else Materialize.toast('Эмулированный маркер создан!', 3000);

        if (data.is_valid) Materialize.toast('Подождите, пока хеш будет замайнен.', 3000);
        commit('loading', false);
        commit('newMarkers', _defineProperty({}, data.hash, { x: data.x, y: data.y }));
      }, function (response) {
        Materialize.toast('Не удалось создать новый маркер.', 3000);
        commit('loading', false);
      });
    },
    addInfo: function addInfo(_ref3, _ref4) {
      ...
      if (isValid) {
        ...
        try {
          state.ethAPI.add({
            ...
            resolve: function resolve(data) {
              return dispatch('addInfoToServer', { image: base64, date: date, x: x, y: y, hash: hash, is_valid: true });
            },
            reject: function reject(err) {
              return Materialize.toast('Ошибка. Не получилось создать запись.', 3000);
            }
          });
        } catch (e) {
        ...
        dispatch('addInfoToServer', { image: base64, date: date, x: x, y: y, hash: hash, is_valid: false });
      }
    },
    loadInfo: function loadInfo(_ref5, hash) {
    ...
    loadMarkers: function loadMarkers(_ref6) {
...
},{"./EthAPI":1,"./contract.json":2,"axios":12,"sha256":79}],5:[function(require,module,exports){
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{staticClass:"modal",attrs:{"id":"add-info-modal"}},[_c('div',{staticClass:"modal-content"},[_c('h4',[_vm._v("Новый маркер")]),_vm._v(" "),_c('br'),_vm._v(" "),_c('div',{staticClass:"row"},[_c('form',{on:{"submit":function($event){$event.preventDefault();_vm.submitNewInfo($event)}}},[_c('div',{staticClass:"file-field input-field"},[_c('div',{staticClass:"btn green"},[_c('span',[_vm._v("Фотография")]),_vm._v(" "),_c('input',{attrs:{"type":"file","required":""},on:{"change":_vm.onFileChange}})]),_vm._v(" "),_vm._m(0)]),_vm._v(" "),_c('div',{staticClass:"input-field сol s12"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.x),expression:"x"}],attrs:{"id":"x-coord","required":"","autocomplete":"off","placeholder":"Введите долготу"},domProps:{"value":(_vm.x)},on:{"input":function($event){if($event.target.composing){ return; }_vm.x=$event.target.value}}})]),_vm._v(" "),_c('div',{staticClass:"input-field сol s12"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.y),expression:"y"}],attrs:{"id":"y-coord","required":"","autocomplete":"off","placeholder":"Введите широту"},domProps:{"value":(_vm.y)},on:{"input":function($event){if($event.target.composing){ return; }_vm.y=$event.target.value}}})]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.isAddHash),expression:"isAddHash"}],staticClass:"filled-in",attrs:{"type":"checkbox","id":"is_add_hash"},domProps:{"checked":Array.isArray(_vm.isAddHash)?_vm._i(_vm.isAddHash,null)>-1:(_vm.isAddHash)},on:{"__c":function($event){var $$a=_vm.isAddHash,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.isAddHash=$$a.concat([$$v]))}else{$$i>-1&&(_vm.isAddHash=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{_vm.isAddHash=$$c}}}}),_vm._v(" "),_c('label',{attrs:{"for":"is_add_hash"}},[_vm._v("Добавить хеш в блокчейн")]),_vm._v(" "),_c('br'),_vm._v(" "),_c('br'),_vm._v(" "),_c('button',{staticClass:"btn waves-effect green"},[_vm._v("СОЗДАТЬ")])])])])]),_vm._v(" "),_vm._m(1)])}
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"file-path-wrapper"},[_c('input',{staticClass:"file-path validate",attrs:{"type":"text"}})])},function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('a',{staticClass:"btn-floating btn-large waves-effect waves-light green modal-trigger",attrs:{"href":"#add-info-modal"}},[_c('i',{staticClass:"material-icons"},[_vm._v("add")])])}]
__vue__options__._scopeId = "data-v-290c3596"
...
},{"vue":82,"vue-hot-reload-api":81,"vueify/lib/insert-css":83}],6:[function(require,module,exports){
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert("#app[data-v-fc265d8e] {\n  min-height: 100vh;\n  overflow: hidden;\n}")
;(function(){
'use strict';

var Navigation = require('./Navigation.vue');
var AddInfoModal = require('./AddInfoModal.vue');
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('navigation'),_vm._v(" "),_c('map-forests'),_vm._v(" "),_c('forest'),_vm._v(" "),_c('ethereum-modal'),_vm._v(" "),_c('add-info-modal'),_vm._v(" "),_c('loader',{directives:[{name:"show",rawName:"v-show",value:(_vm.loading),expression:"loading"}]})],1)}
...
},{"./AddInfoModal.vue":5,"./EthereumModal.vue":7,"./Forest.vue":8,"./Loader.vue":9,"./MapForests.vue":10,"./Navigation.vue":11,"vue":82,"vue-hot-reload-api":81,"vueify/lib/insert-css":83}],7:[function(require,module,exports){
...
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('a',{staticClass:"btn-floating btn-large waves-effect waves-light green modal-trigger",attrs:{"href":"#ethereum-key-modal"}},[_c('i',{staticClass:"material-icons"},[_vm._v("account_balance_wallet")])])}]
...
},{"../store":4,"vue":82,"vue-hot-reload-api":81,"vueify/lib/insert-css":83}],8:[function(require,module,exports){
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert(".modal[data-v-42610996] {\n  background: none;\n  box-shadow: none;\n  overflow-y: initial;\n}\n.card-content[data-v-42610996] {\n  position: absolute;\n  bottom: 0px;\n  background: #fff;\n  width: 100%;\n}\n@media (max-width: 1280px) {\n  .card-content[data-v-42610996] {\n    bottom: -50px;\n  }\n}\n@media (max-width: 720px) {\n  .card-content[data-v-42610996] {\n    bottom: -100px;\n  }\n}")
;(function(){
'use strict';
...
module.exports = {
  ...
  filters: {
    formatDate: function formatDate(date, template) {
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"modal",attrs:{"id":"forest"}},[_c('div',{staticClass:"card modal-fixed-footer"},[_c('div',{staticClass:"card-image"},[_c('img',{staticClass:"responsive-img materialboxed",attrs:{"src":_vm.info.image}})]),_vm._v(" "),_c('div',{staticClass:"card-content"},[_c('p',{staticClass:"flow-text"},[_vm._v("Дата: "+_vm._s(_vm._f("formatDate")(_vm.info.date,'MM/DD/YYYY, HH:mm:ss')))]),_vm._v(" "),_c('p',{staticClass:"flow-text"},[_vm._v("Долгота: "+_vm._s(_vm.info.x)+"°")]),_vm._v(" "),_c('p',{staticClass:"flow-text"},[_vm._v("Широта: "+_vm._s(_vm.info.y)+"°")])])])])}
__vue__options__.staticRenderFns = []
...
},{"vue":82,"vue-hot-reload-api":81,"vueify/lib/insert-css":83}],9:[function(require,module,exports){
...
},{"vue":82,"vue-hot-reload-api":81,"vueify/lib/insert-css":83}],10:[function(require,module,exports){
...
module.exports = {
  ...
  created: function created() {
    ...
    window.initMap = function () {
      ...
      _this2.$store.dispatch('loadMarkers');
    };
  }
};
})()
...
},{"vue":82,"vue-hot-reload-api":81,"vueify/lib/insert-css":83}],12:[function(require,module,exports){
...
},{"../core/createError":20,"./../core/settle":23,"./../helpers/btoa":27,"./../helpers/buildURL":28,"./../helpers/cookies":30,"./../helpers/isURLSameOrigin":32,"./../helpers/parseHeaders":34,"./../utils":36,"_process":78}],14:[function(require,module,exports){
'use strict';
...
},{"./adapters/http":13,"./adapters/xhr":13,"./helpers/normalizeHeaderName":33,"./utils":36,"_process":78}],26:[function(require,module,exports){
'use strict';
...
},{"./helpers/bind":26,"is-buffer":77}],37:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/keys"), __esModule: true };
},{"core-js/library/fn/object/keys":42}],38:[function(require,module,exports){
'use strict'
...
},{"base64-js":38,"ieee754":76}],40:[function(require,module,exports){
!function(globals) {
'use strict'
...
},{"../../modules/_core":47,"../../modules/es6.object.keys":75}],43:[function(require,module,exports){
...
},{"./_is-object":60}],45:[function(require,module,exports){
// false -> Array#indexOf
// true  -> Array#includes
...
},{"./_to-absolute-index":68,"./_to-iobject":70,"./_to-length":71}],46:[function(require,module,exports){
...
},{"./_a-function":43}],49:[function(require,module,exports){
...
},{"./_global":55,"./_is-object":60}],52:[function(require,module,exports){
...
},{"./_core":47,"./_ctx":48,"./_global":55,"./_hide":57}],54:[function(require,module,exports){
...
},{"./_descriptors":50,"./_object-dp":61,"./_property-desc":65}],58:[function(require,module,exports){
module.exports = !require('./_descriptors') && !require('./_fails')(function () {
  return Object.defineProperty(require('./_dom-create')('div'), 'a', { get: function () { return 7; } }).a != 7;
});

},{"./_descriptors":50,"./_dom-create":51,"./_fails":54}],59:[function(require,module,exports){
...
},{"./_cof":46}],60:[function(require,module,exports){
module.exports = function (it) {
...
},{"./_an-object":44,"./_descriptors":50,"./_ie8-dom-define":58,"./_to-primitive":73}],62:[function(require,module,exports){
...
},{"./_array-includes":45,"./_has":56,"./_shared-key":66,"./_to-iobject":70}],63:[function(require,module,exports){
...
},{"./_enum-bug-keys":52,"./_object-keys-internal":62}],64:[function(require,module,exports){
...
},{"./_core":47,"./_export":53,"./_fails":54}],65:[function(require,module,exports){
...
},{"./_shared":67,"./_uid":74}],67:[function(require,module,exports){
var global = require('./_global');
...
},{"./_global":55}],68:[function(require,module,exports){
...
},{"./_defined":49,"./_iobject":59}],71:[function(require,module,exports){
// 7.1.15 ToLength
var toInteger = require('./_to-integer');
var min = Math.min;
module.exports = function (it) {
...
},{"./_defined":49}],73:[function(require,module,exports){
...
},{"./_is-object":60}],74:[function(require,module,exports){
var id = 0;
var px = Math.random();
module.exports = function (key) {
...
},{"./_object-keys":63,"./_object-sap":64,"./_to-object":72}],76:[function(require,module,exports){
...
},{"convert-hex":40,"convert-string":41}],80:[function(require,module,exports){
/**
...
},{"_process":78}],83:[function(require,module,exports){
